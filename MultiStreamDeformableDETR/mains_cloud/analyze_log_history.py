...
if __name__ == '__main__':
    ...
    project_name = 'ETRIGJHallDeploy/T10avgp_imageavgp_encv2avgp_pca1dlcnmsSoftmaxAttnSimpleAbsdiff_frzDETR_wDet21c_v3_allTraining_EarlyStop_MultiGPUs/list_captured2_dayRest'
